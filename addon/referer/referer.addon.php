<?php
		...
		&& ($addon_info->include_direct_access == "yes" || !empty($_SERVER["HTTP_REFERER"])))
	{
		...
		if ($addon_info->exclude_bot == 'yes' && !strstr($uagent, 'SocialXE ClientBot')
			&& (preg_match("/bot|spider|crawler|slurp|yeti|daumoa|FeedDemon|Aboundex|NewsGatorOnline|DigExt|inboundscore|feedfetcher|Teoma|siteexplorer|recruitingpoint|NetcraftSurveyAgent|bing/i", $uagent)
