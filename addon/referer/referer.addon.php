...
//if($called_position == 'before_module_init' && Context::get('module') != 'admin'
//  && !$GLOBALS['__referer_addon_called__'] && ($addon_info->include_direct_access == "yes" || !empty($_SERVER["HTTP_REFERER"])))
if(Context::get('module') != 'admin' && !$GLOBALS['__referer_addon_called__'] && ($addon_info->include_direct_access == "yes" || !empty($_SERVER["HTTP_REFERER"])))
{
